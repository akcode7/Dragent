  ...
  const cprSteps = [
    {
      ...
      image: "/assets/images/cpr-check.svg", // These image paths are placeholders
      tips: "Look for chest rise, listen for breath, feel for air from mouth and nose."
    },
    {
      title: "Call Emergency Services",
      instruction: "If the person is unresponsive, call emergency services (102 in India) or ask someone else to call while you begin CPR.",
      image: "/assets/images/cpr-call.svg",
    ...
    },
    {
      ...
      image: "/assets/images/cpr-position.svg",
    ...
    },
    {
      ...
      image: "/assets/images/cpr-hands.svg",
    ...
    },
    {
      ...
      image: "/assets/images/cpr-compress.svg",
    ...
    },
    {
      ...
      image: "/assets/images/cpr-breath.svg",
    ...
    },
    {
      ...
      image: "/assets/images/cpr-repeat.svg",
    ...
    },
    {
      ...
      image: "/assets/images/cpr-aed.svg",
        ...
        <div className="p-6">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-1/2 flex justify-center items-center">
              <div className="bg-gray-100 p-4 rounded-lg w-full h-64 flex items-center justify-center">
                {/* Replace with actual images when available */}
                <div className="text-center text-gray-500">
                  [CPR Illustration: {cprSteps[currentStep].title}]
                </div>
              </div>
            </div>
          </div>
