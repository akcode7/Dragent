      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            <Link href="/dental" className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/40 transition-colors">
              <div className="flex flex-col items-center text-center">
                <div className="w-10 h-10 bg-blue-100 dark:bg-blue-600 rounded-full flex items-center justify-center text-blue-600 dark:text-blue-300 mb-2">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start space-x-3">
              <div className="flex-shrink-0 w-10 h-10 bg-blue-100 dark:bg-blue-600 rounded-full flex items-center justify-center text-blue-600 dark:text-blue-300">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
